...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\n// https://tetris.wiki/Super_Rotation_System\nvar SuperRotationSystem = /** @class */ (function () {\n    function SuperRotationSystem(world) {\n        this.world = world;\n    }\n    SuperRotationSystem.prototype.rotate = function (direction) {\n        var withRotationApplied = this.world.tetromino.previewRotation(direction);\n        var wouldCollideWithOccupied = this.world.occupiedLocations.filter(function (loc) { return loc.x == nextX && loc.y == nextY; }).length;\n        if (wouldCollideWithOccupied) {\n        }\n        var wallKicks = [];\n        // this.world.tetromino.rotate(direction);\n    };\n    return SuperRotationSystem;\n}());\nexports.SuperRotationSystem = SuperRotationSystem;\n\n\n//# sourceURL=webpack://lib/./src/tetris/SuperRotationSystem.ts?");
